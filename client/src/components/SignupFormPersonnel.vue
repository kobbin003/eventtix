...
const emit = defineEmits(["personnelData", "prevStep", "submit"]);
		...
		<form class="flex flex-col gap-2">
			...
			<ul>
				<li
					...
					class="flex justify-between items-center gap-2 bg-base-100"
				>
			...
			<div class="flex justify-between py-2">
				...
				<button @click="next" type="button" class="btn btn-md btn-info">
					Submit
				</button>
			</div>
		</form>
